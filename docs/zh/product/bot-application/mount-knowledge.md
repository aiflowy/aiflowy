...
![mount_document_col.png](resource/mount_document_col.png)

## 3. 知识库测试
如图 聊天助手 根据用户的输入，从知识库中检索出答案，得到的答案是经过大模型处理过的，所以答案会更加准确
![mount_document__1.png](resource/mount_document__1.png)    
![mount_document_test.png](resource/mount_document_test.png)
