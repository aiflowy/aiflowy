...
import { LockKeyhole } from '@aiflowy/icons';
import { $t, useI18n } from '@aiflowy/locales';
import { storeToRefs, useAccessStore } from '@aiflowy/stores';

import { useScrollLock } from '@aiflowy-core/composables';
import { useAIFlowyForm, z } from '@aiflowy-core/form-ui';
import { AIFlowyAvatar, AIFlowyButton } from '@aiflowy-core/shadcn-ui';
...
const [Form, { form, validate, getFieldComponentRef }] = useAIFlowyForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    schema: computed(() => [
      {
        component: 'AIFlowyInputPassword' as const,
        componentProps: {
    ...
    <transition name="slide-right">
      ...
      >
        <div class="flex-col-center mb-10 w-[90%] max-w-[300px] px-4">
          <AIFlowyAvatar :src="avatar" class="enter-x mb-6 size-20" />
          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <AIFlowyButton class="enter-x w-full" @click="handleSubmit">
