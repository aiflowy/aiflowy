...
import { AIFlowyIcon, AIFlowyTooltip } from '@aiflowy-core/shadcn-ui';
  ...
  >
    ...
    >
      <template #trigger>
        <div :class="[nsMenu.be('tooltip', 'trigger')]">
          <AIFlowyIcon :class="nsMenu.e('icon')" :icon="menuIcon" fallback />
          <slot></slot>
    ...
    <div v-show="!showTooltip" :class="[e('content')]">
      <MenuBadge
        ...
        v-bind="props"
      />
      <AIFlowyIcon :class="nsMenu.e('icon')" :icon="menuIcon" />
      <slot></slot>
      <slot name="title"></slot>
    </div>
  </li>
