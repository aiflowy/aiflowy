...
import { Input, AIFlowyRenderContent } from '@aiflowy-core/shadcn-ui';
import { isFunction, isString } from '@aiflowy-core/shared/utils';
...
export function aiflowyAlert(options: AlertProps): Promise<void>;
export function aiflowyAlert(
  message: string,
...
export function aiflowyConfirm(options: AlertProps): Promise<void>;
export function aiflowyConfirm(
  message: string,
  options?: Partial<AlertProps>,
): Promise<void>;
export function aiflowyConfirm(
...
export function aiflowyConfirm(
  ...
  if (!arg1) {
    return isString(arg0)
      ? aiflowyAlert(arg0, defaultProps)
      : aiflowyAlert({ ...defaultProps, ...arg0 });
  } else if (!arg2) {
    return isString(arg1)
      ? aiflowyAlert(arg0 as string, arg1, defaultProps)
      : aiflowyAlert(arg0 as string, { ...defaultProps, ...arg1 });
  }
  return aiflowyAlert(arg0 as string, arg1 as string, {
    ...defaultProps,
    ...arg2,
  });
}

export async function aiflowyPrompt<T = any>(
  ...
  staticContents.push(h(AIFlowyRenderContent, { content, renderBr: true }));
