...
import { getPackages } from '@aiflowy/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  // 需要忽略的包
  ignorePackages: [
    '@aiflowy/backend-mock',
    '@aiflowy/commitlint-config',
    '@aiflowy/eslint-config',
    '@aiflowy/node-utils',
    '@aiflowy/prettier-config',
    '@aiflowy/stylelint-config',
    '@aiflowy/tailwind-config',
    '@aiflowy/tsconfig',
    '@aiflowy/vite-config',
    '@aiflowy/vsh',
