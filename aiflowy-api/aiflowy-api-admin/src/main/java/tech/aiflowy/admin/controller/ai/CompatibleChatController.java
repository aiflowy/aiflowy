...
//                RequestContextHolder.setRequestAttributes(sra, true);
//                StreamResponseListener.logger.info("大模型回复：{}", aiMessageResponse.getResponse());
//
...
//                StreamResponseListener.logger.error("fail:{}", throwable.getMessage());
...
//
//                RequestContextHolder.setRequestAttributes(sra, true);
//                StreamResponseListener.logger.info("大模型 function calling 回复：{}", response.getResponse());
...
//            @Override
//            public void onFailure(ChatContext context, Throwable throwable) {
//                StreamResponseListener.logger.error("function fail:{}", throwable.getMessage());
